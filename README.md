...
*   **Cross-Machine Lock:** A lock file (`.mixxx_is_active`) prevents the library from being opened simultaneously across all your machines, with no "proceed anyway" override.
